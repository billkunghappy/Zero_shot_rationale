...
with open(data_path, 'r') as csvFile:
    ...
    for rows in csvReader:
        ...
        for __answers in rows['Task 2'].split():
            check_answer_id += label_to_id[__answers]
        if check_answer_id != int(sys.argv[3]):
            continue
        ...
        for i in range(paragraph_num):
            ...
            for j in range(QANum):
                ...
                if is_reason:
                    now_qa["question"] = MyQuestion + id_to_label[int(sys.argv[4])] + " ?"
